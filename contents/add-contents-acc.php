...
//print_r($_REQUEST['topicId']);die();
    ...
    $qry = "INSERT INTO `contents` VALUES (NULL, '".$_REQUEST['course']."', '".$_SESSION['id']."', '".$_REQUEST['cont-name']."', '".$_REQUEST['type']."', '".$_REQUEST['link']."', '".$_REQUEST['content']."', '".$teacher['name']."', '".date("Y-m-d H:i:s")."', '".date("Y-m-d H:i:s")."',  'active')";
