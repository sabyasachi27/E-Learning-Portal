...
if ($num == 0) {
    ...
    if ($_POST) {
        ...
        if (!empty('email') && !empty('password')) {
            ...
            $qry = "INSERT INTO `student` VALUES (NULL, '" . $path . "', '" . $_REQUEST['name'] . "', '" . $_POST['email'] . "', '" . $password . "', '" . $_REQUEST['mobile'] . "', 'active', '" . $token . "', '0')";
            ...
            if ($qry_exec) {
                ...
                try {
                    ...
                    <a href ="http://localhost/StudyLand/student/valid-student.php?email=' . $email . '&token=' . $token . '">Click Here</a>';
